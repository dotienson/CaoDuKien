export const translations = {
  vi: {
    ...
    boneAge: "Tuổi xương hiện tại (RUS)",
    ...
    outOfRange: "Kết quả ngoài khoảng, cần đánh giá lại.",
  ...
  en: {
    ...
    outOfRange: "Result out of range, needs re-evaluation.",
